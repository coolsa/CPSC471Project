...
public class AircraftApi {
	...
	@io.swagger.annotations.ApiOperation(value = "adds a new aircraft", notes = "", response = Void.class, authorizations = {
			@io.swagger.annotations.Authorization(value = "airsched_auth") }, tags = {})
	...
	public Response addAircraft(@ApiParam(value = "The new aircraft to add.") @Valid Aircraft aircraft,
	...
	public Response addFlight(
			@ApiParam(value = "The new flight to add. As flight needs a referenced aircraft, this should be fine.") @Valid Flight flight,
			@Context SecurityContext securityContext) throws NotFoundException {
	...
	@io.swagger.annotations.ApiResponses(value = {
			...
			@io.swagger.annotations.ApiResponse(code = 200, message = "Success response", response = Void.class) })
	public Response addScheduleForAircraft(@PathParam("aircraft_id") Long aircraftId,
			@ApiParam(value = "The schedule to add for an aircraft.", required = true) @NotNull @Valid AircraftSchedule aircraftSchedule,
			@Context SecurityContext securityContext) throws NotFoundException {
	...
	@io.swagger.annotations.ApiResponses(value = {
			...
			@io.swagger.annotations.ApiResponse(code = 200, message = "success response", response = Void.class) })
	public Response deleteFlightFromSchedule(@PathParam("aircraft_id") Long aircraftId,
			@PathParam("flight_id") Long flightId, @Context SecurityContext securityContext) throws NotFoundException {
	...
	public Response getScheduleForAircraft(@PathParam("aircraft_id") Long aircraftId,
			@Context SecurityContext securityContext) throws NotFoundException {
	...
	@io.swagger.annotations.ApiResponses(value = {
			...
			@io.swagger.annotations.ApiResponse(code = 200, message = "success response", response = Void.class) })
	public Response updateAircraft(@PathParam("aircraft_id") Long aircraftId,
			@ApiParam(value = "the updated aircraft", required = true) @NotNull @Valid Aircraft aircraft,
			@Context SecurityContext securityContext) throws NotFoundException {
	...
	@io.swagger.annotations.ApiResponses(value = {
			...
			@io.swagger.annotations.ApiResponse(code = 200, message = "success response", response = Void.class) })
	public Response updateFlight(@PathParam("flight_id") Long flightId,
			@ApiParam(value = "The updated flight, replaces at the id passed", required = true) @NotNull @Valid Flight flight,
			@Context SecurityContext securityContext) throws NotFoundException {
