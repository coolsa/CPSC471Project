    ...
    void InstructorPortal(int id){
        try {
            ...
            while(loop) {
                ...
                switch (caseID) {
                    case 1:
                        ResultSet allUsersFlights = stmt.executeQuery("SELECT * FROM Flight WHERE Instructor_id = " + id);
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        ResultSet allInstructors = stmt.executeQuery("SELECT * FROM Teaches WHERE Instructor_id = " + id);
