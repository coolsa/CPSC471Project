package main.server.configuration;
...
public class OpenAPIDocumentationConfig {
    ...
    @Bean
    public Docket customImplementation(ServletContext servletContext, @Value("${openapi.airSchedual.base-path:}") String basePath) {
